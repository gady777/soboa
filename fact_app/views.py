     ...
     def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if created:
                ...
                messages.success(request, "Client enregistré avec success.")

            else:

                messages.error(request, "Désolé, essayé a nouveau .")
...
class AddInvoiceView(LoginRequiredSuperuserMixim, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try: 
            ...
            if created:
                messages.success(request, "Donnees enregistrer avec success.") 
            else:
                messages.error(request, "Désolé, essayé a nouveau.")    
